...
namespace HcBimUtils.MoreLinq
{
   ...
   static partial class MoreEnumerable
   {
      ...
      /// <exception cref="System.ArgumentNullException"><paramref name="source"/> or <paramref name="selector"/> is null</exception>
      ...
      /// <returns>The maximal element, according to the projection.</returns>
      /// <exception cref="System.ArgumentNullException"><paramref name="source"/>, <paramref name="selector"/>
      ...
      private sealed class ExtremaEnumerable<T, TKey> : IExtremaEnumerable<T>
      {
         ...
         private sealed class Extremum : Extrema<(bool HasValue, T Value), T>
         {
            ...
            private Extremum(bool poppable) => _poppable = poppable;
      ...
      private static IEnumerable<TSource> ExtremaBy<TSource, TKey, TStore>(
